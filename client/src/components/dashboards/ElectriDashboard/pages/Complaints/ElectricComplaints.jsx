...
const ElectricComplaints = () => {
    ...
    const fetchComplaints = async () => {
        try {
            ...
            const res = await axios.get("http://localhost:2000/complaints/electric");
    ...
    return (
        ...
        <div className="ElectricComplaints">

            <div className="deptTop">

                <h2>Electric Department Complaints</h2>
...
export default ElectricComplaints;